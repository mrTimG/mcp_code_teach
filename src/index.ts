...
import { javascriptObjectsArrays } from "./prompts/javascriptObjectsArrays.js";
...
server.registerTool(
  "javascript_objs_arrays",
  {
    title: "Javascript complex variable types  ",
    description: "an introduction to javascript objects, arrays and loops",
    inputSchema: z.object({})
  },
  async (args) => {
    return {
      content: [{ type: "text", text: javascriptObjectsArrays }]
    };
  }
);
